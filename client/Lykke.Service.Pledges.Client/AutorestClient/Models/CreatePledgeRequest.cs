...
namespace Lykke.Service.Pledges.Client.AutorestClient.Models
{
    ...
    public partial class CreatePledgeRequest
    {
        /// <summary>
        /// Initializes a new instance of the CreatePledgeRequest class.
        /// </summary>
        public CreatePledgeRequest()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the CreatePledgeRequest class.
        /// </summary>
        public CreatePledgeRequest(int cO2Footprint, int climatePositiveValue, string clientId = default(string))
        {
            ClientId = clientId;
