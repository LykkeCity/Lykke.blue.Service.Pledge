...
namespace Lykke.Service.Pledges.Client.AutorestClient.Models
{
    ...
    public partial class CreatePledgeResponse
    {
        /// <summary>
        /// Initializes a new instance of the CreatePledgeResponse class.
        /// </summary>
        public CreatePledgeResponse()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the CreatePledgeResponse class.
        /// </summary>
        public CreatePledgeResponse(int cO2Footprint, int climatePositiveValue, string id = default(string), string clientId = default(string))
        {
            Id = id;
            ClientId = clientId;
